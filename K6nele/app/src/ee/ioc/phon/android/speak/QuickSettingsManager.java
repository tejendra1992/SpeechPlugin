...
public class QuickSettingsManager {
    ...
    public void setWsServerGlobalWs() {
        ...
        editor.putString(mRes.getString(R.string.keyWsServer), "ws://services.govivace.com:49154/telephony");
        editor.apply();
    }
    ...
    public void setWsServerGlobalWss() {
        ...
        editor.putString(mRes.getString(R.string.keyWsServer), "wss://services.govivace.com:49153/telephony");
        editor.apply();
    }
